...
public class DriverRestController {
    ...
    //changer status d'un chauffeur
    @PatchMapping("/{id}/status")
    public void changeStatus(
            @PathVariable Long id,
            @Valid @RequestParam DriverStatus status
    ) {
    ...
    //Avoir les chauffeurs avec license valide
    @GetMapping("/valid-license")
    public List<DriverResponse> findDriversWithValidLicense() {
        return driverService.findDriversWithValidLicense();
    }
